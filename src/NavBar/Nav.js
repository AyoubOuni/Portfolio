...
function active(id){
  const tab=['about1','service1','skills1','education1','experience1','contact1'];
  tab.map((e)=>{
    if(e!=id){
...
if(id ==='eng'){
    ...
    <React.Fragment >
        ...
        <span id="progress" class="progress dn">
	<span class="fill"></span></span>
        <div className="blue "  ><span className="head" id="head" >Ayoub Ouni</span>
    <div className="d-flex justify-content-end ">
       <div className="marg">
       <span className="marg2">
        <a  onClick={()=> {window.scrollTo({top: 0, behavior: "smooth"});}} className= "notactive" href="#home"  id="home"> <span className="hov"> <span className="position-relative " style={{bottom: "2.5px",marginRight:'3px'}}></span>{(language===false)?"Acceuil":"Home"}</span></a>
        <a href="#about" onClick={()=>active('about1')} style={{marginLeft: "-7.5px"}} className= "notactive"  id="about1"><span className="hov"><span className="position-relative " style={{bottom: "2.5px",marginRight:'3px'}}></span>{(language===false)?" À propos ":"About"}</span></a>
        <a href="#service" onClick={()=>active('service1')} style={{marginLeft: "-7.5px"}} className= "notactive"  id="service1"><span className="hov"><span className="position-relative " style={{bottom: "2.5px",marginRight:'3px'}}></span>{(language===false)?" SERVICE":"SERVICES"}</span></a>
        <a onClick={()=>{active('skills1');}} style={{marginLeft: "-7.5px"}} className= "notactive" id="skills1" href="#skills" ><span className="hov"><span className="position-relative " style={{bottom: "2.5px",marginRight:'3px'}}></span>{(language===false)?" Compétences  ":"Skills"}</span></a>
        <a onClick={()=>active('education1')} style={{marginLeft: "-7.5px"}} className= "notactive" href="#education" id='education1'><span className="hov"><span className="position-relative " style={{bottom: "2.5px",marginRight:'3px'}}></span>{(language===false)?" Éducation  ":"Education"}</span></a>
        <a onClick={()=>active('experience1')} style={{marginLeft: "-7.5px"}} className= "notactive" href="#experience" id="experience1"><span className="hov"><span className="position-relative " style={{bottom: "2.5px",marginRight:'3px'}}></span>{(language===false)?" Expérience  ":"Experience"}</span></a>
        <a onClick={()=>active('projects1')} style={{marginLeft: "-7.5px"}} className= "notactive" href="#projects" id="projects1"><span className="hov"><span className="position-relative " style={{bottom: "2.5px",marginRight:'3px'}}></span>{(language===false)?" Projets  ":"Projects"}</span></a>
        <a  onClick={()=>active('contact1')} style={{marginLeft: "-7.5px"}}className= "notactive" href="#contact"id='contact1'><span className="hov"><span className="position-relative " style={{bottom: "2.5px",marginRight:'3px'}}></span>Contact</span></a>
       </span>
  ...
  <span>
   ...
   <div className='show_littlescreen'>
    <span className="  d-flex justify-content-end position-absolute bhy  end-0 " style={{top: '3.8px'}}>
    ...
    <nav >
        ...
        <input  type="checkbox" id="drop" />
           <ul className="menu text-center w-100" style={{textTransform:'uppercase'}} >
           ...
           <li> <a  href="#service"  onClick={()=> {hide();}} id="service2"><span className="position-relative " style={{bottom: "2.5px"}}><MdWork/></span> {(language===false)?" SERVICE ":"SERVICES"}</a> <hr className="hr"/></li>
